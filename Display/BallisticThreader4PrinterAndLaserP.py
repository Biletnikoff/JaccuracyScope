...
class BallisticThread(Thread): 
    ...
    def aero(self,t,y):
        ...
        #Cd = .308; 
        Cd = np.interp(mach, self.g7_m, self.myg7) ## Linear interp - needs mach number interpolation
            ...
            for i in range (1,self.MafVal+1,1): 
                ...
                if  (self.solver == "GNUsolver"):
                    ...
                    if (self.ScopeMode == 0 ):
                        ...
                        #extra wind correction for algorithm
                        ...
                        #### Free all memory to avoid RAM overload
                        self.GNUfree(1)
